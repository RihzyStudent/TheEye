...
print(f"\nPeriod search window: {Pmax:.2f} - {Pmin:.2f} days")

# Query the catalog - we'll use the detected period later if available
...
Depth, Dur_h, k = correct_tls_depth_duration(r, lc_new.time.value,flfrcsap)
SDE = float(r.SDE)
